  ...
  return (
    <footer className="h-full flex py-1 justify-between">
      <div className="h-full">
        <ul className="font-helveticLight  text-dark [&>li]:leading-[14px] [&>li]:text-sm flex flex-col justify-between h-full">
          <li>
      ...
      <div className="h-full">
        <ul className="font-helveticLight text-right text-dark [&>li]:leading-[14px] [&>li]:text-sm flex flex-col justify-between h-full">
