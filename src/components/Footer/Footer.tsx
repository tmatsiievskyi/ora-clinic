  ...
  return (
    <footer className="h-full flex py-1 justify-between items-end md:items-center">
      <div className="h-full">
        <ul className="font-comfortaa max-w-[148px] md:max-w-[500px] break-all text-dark [&>li]:leading-[14px] [&>li]:text-sm flex flex-col justify-end md:justify-between h-full">
      ...
      <div className="h-full">
        <ul className="font-comfortaa text-right text-dark [&>li]:leading-[14px] [&>li]:text-sm flex flex-col justify-between h-full">
          <li className="mb-2 md:mb-1">м. Дрогобич, вул. Івана Франка, 4</li>
